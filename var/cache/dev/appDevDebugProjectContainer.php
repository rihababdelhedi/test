...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'fioulmarket', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\FioulmarketBundle\\Entity'))), 'FioulmarketBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('FioulmarketBundle' => 'FioulmarketBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d33d1a828260dfa046503ff3a9e01a1aca5245a3feae6af05b7cdb19d4659062');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \FioulmarketBundle\Service\ConvertCsvToArray A FioulmarketBundle\Service\ConvertCsvToArray instance
     */
    protected function getImport_CsvtoarrayService()
    {
        return $this->services['import.csvtoarray'] = new \FioulmarketBundle\Service\ConvertCsvToArray();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\FioulmarketBundle/Resources/views'), 'Fioulmarket');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6c1f0eefe6791b6b95caa7b01e003e0889481181');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5964c002d67824.91235905')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FioulmarketBundle' => 'FioulmarketBundle\\FioulmarketBundle',
            ...
            'secret' => '6c1f0eefe6791b6b95caa7b01e003e0889481181',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '6c1f0eefe6791b6b95caa7b01e003e0889481181',
